...
; IO_AREA         = $DF00   ; Before V1.31
IO_AREA         = $0300   ; V1.31 and later
;__________________________________________________________________________________________________
...
; NATIVE VECTORS
ICOPVECTOR      = $0700         ;COP handler indirect vector...
IBRKVECTOR      = $0702         ;BRK handler indirect vector...
IABTVECTOR      = $0704         ;ABT handler indirect vector...
INMIVECTOR      = $0706         ;NMI handler indirect vector...
IIRQVECTOR      = $0708         ;IRQ handler indirect vector...
; 6502 Emulation Vectors
IECOPVECTOR     = $070A         ;ECOP handler indirect vector...
IEABTVECTOR     = $070C         ;EABT handler indirect vector...
IENMIVECTOR     = $070E         ;ENMI handler indirect vector...
IEINTVECTOR     = $0710         ;EINT handler indirect vector...
ConsoleDevice   = $0712         ; Current Console Device
; $00 On-Board Serial
