;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; DISKIO.ASM -- Parallel Port IDE driver
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;* Updated 1-Jul-2010 Max Scane - Added DISKIO driver and conditionals
;
...
%include	"disk.inc"
        ...
        global  _DISKIO_WRITE_SECTOR
        global  _DISKIO_READ_SECTOR
        global  _DISKIO_READ_ID
        extern  @mulLS
                extern  microsecond
...
IDELSB          equ     DISKIO_PPIDE    ; LSB
IDEMSB          equ     IDELSB+1        ; MSB
IDECTL		equ	IDELSB+2        ; Control Signals
PIO1CONT	equ	IDELSB+3	; CONTROL BYTE PIO 82C55
...
;
;-----------------------------------------------------------------------------
@DISKIO_VERIFY_SECTOR:
        pushm   ax,dx,cx
        call    _DISKIO_VERIFY_SECTOR
        popm    ax,dx,cx
        ret

_DISKIO_VERIFY_SECTOR:
        push    bp
        mov     bp,sp
        pushm   es,bx
...
@DISKIO_WRITE_SECTOR:
        pushm   bx,es,ax,dx,cx
        call    _DISKIO_WRITE_SECTOR
        popm    bx,es,ax,dx,cx
        ret

_DISKIO_WRITE_SECTOR:
        push    bp
        mov     bp,sp
        pushm   es,bx
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;  BIOS call entry for DISKIO Fixed Disk driver
;       int  13h
;
...
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        global  DISKIO_BIOS_call_13h
DISKIO_BIOS_call_13h:          ; Floppy driver entry
...
; LBA call is okay
        ...
        jnz     .3
.2:     call    @DISKIO_READ_SECTOR
        jmp     .5
.3:     call    @DISKIO_WRITE_SECTOR
        jmp     .5
.4:     call    @DISKIO_VERIFY_SECTOR
...
;
;  This operation is a complete No-Op for the DISKIO
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
fn4E:
        call    integrity
