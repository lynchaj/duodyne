...
entity main is
  port (
    ...
    notIM2xS2: out std_logic;
    notIM2xS1: out std_logic;
    notIM2xS0: out std_logic;
...
begin
  ...
  gate2: entity work.n74153
    port map (
      ...
      GND => '0',
      n1Y => s3);
  s4 <= NOT (notCPUxMREQ AND notCPUxIORQ);
  ...
  s2 <= (s1 OR CPU_A1);
  notCSxI2C_temp <= (s1 OR NOT CPU_A1);
  READY <= (NOT (s4 AND notCPUxRFSH) OR s3);
  ...
  gate5: entity work.n7474
    port map (
      n1notSD => '1',
      n1D => CPU_D0,
      n1CP => s2,
      n1notRD => notCPUxRESET,
      n2notSD => '1',
      n2D => '1',
      n2CP => '1',
      n2notRD => '1',
