...
WELCOME_MESS:
        ...
        DB      CR,LF,"  _____                  _ "
        DB      CR,LF," |  __ \                | |"
        DB      CR,LF," | |  | |_   _  ___   __| |_   _ _ __   ___ "
        DB      CR,LF," | |  | | | | |/ _ \ / _` | | | | '_ \ / _ \ "
        DB      CR,LF," | |__| | |_| | (_) | (_| | |_| | | | |  __/"
        DB      CR,LF," |_____/ \__,_|\___/ \__,_|\__, |_| |_|\___|"
        DB      CR,LF,"    80c188 pcb              __/ |"
        DB      CR,LF,"                           |___/ "
        DB      CR,LF,"MON88 8088/8086 Monitor ver 0.1"
