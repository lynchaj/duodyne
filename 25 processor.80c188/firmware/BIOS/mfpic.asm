;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; MFPIC.ASM -- Parallel Port IDE driver
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;* Updated 1-Jul-2010 Max Scane - Added MFPIC driver and conditionals
;
...
%include	"disk.inc"
        ...
        global  _MFPIC_WRITE_SECTOR
        global  _MFPIC_READ_SECTOR
        global  _MFPIC_READ_ID
        extern  @mulLS
                extern  microsecond

;
; PIO 82C55 I/O IS ATTACHED TO THE 4TH IO BASE ADDRESS

IDELSB          equ     MFPIC_PPIDE	; LSB
IDEMSB          equ     MFPIC_PPIDE+1	; MSB
IDECTL		equ	MFPIC_PPIDE+2	; Control Signals
PIO1CONT	equ	MFPIC_PPIDE+3	; CONTROL BYTE PIO 82C55
...
@MFPIC_VERIFY_SECTOR:
        pushm   ax,dx,cx
        call    _MFPIC_VERIFY_SECTOR
        popm    ax,dx,cx
        ret

_MFPIC_VERIFY_SECTOR:
        push    bp
        mov     bp,sp
        pushm   es,bx
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;  BIOS call entry for MFPIC Fixed Disk driver
;       int  13h
;
...
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        global  MFPIC_BIOS_call_13h
MFPIC_BIOS_call_13h:          ; Floppy driver entry
...
; LBA call is okay
        ...
        jnz     .3
.2:     call    @MFPIC_READ_SECTOR
        jmp     .5
.3:     call    @MFPIC_WRITE_SECTOR
        jmp     .5
.4:     call    @MFPIC_VERIFY_SECTOR
...
;
;  This operation is a complete No-Op for the MFPIC
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
fn4E:
        call    integrity
