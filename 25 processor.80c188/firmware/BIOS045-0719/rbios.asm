;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; RBIOS.ASM -- Relocatable BIOS for the RetroBrew SBC-188 v.00.4 to 00.7
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
...
;       00.4    prototype board
;       00.5    00.4 board + memory select mod
;       00.6    00.4 board + timer & SRDY mods
;       00.7    00.4 board + FDC /DACK & TC mod
; ----------------------------------------------------------------
...
ident2:
        db      NL
	db	"%12a"
        db      "Copyright (C) 2010-2017 by The RetroBrew Users' Group.  All rights reserved."
        db      NL
        ...
        db      NL
        db      "is contained in the file COPYING.TXT in the top-level source directory."
        db      NL
%if SOFT_DEBUG
        db      NL
	db	"%7a"
...
%if FRONT_PANEL
	CPUUP	    DB 	001h,04Eh,067h,03Eh,000h,03Eh,067h,001h
	POSTMSG	    DB 	001h,001h,067h,07Eh,05Bh,070h,001h,001h
	BASICMSG    DB 	001h,001h,01Fh,077h,05Bh,030h,04Eh,001h
%endif
...
%if 0
 /* SOFT_DEBUG > 1 */
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; set up for LED lights display on PPI portB
; 6/14/2017 -- now called portD, may equ portB, or separate on 0x4FF
        mov     dx,PIO_CTRL
        mov     al,99h          ; Mode 0, portA=input, portC=input, 
                                ;         portB=output (lites)
        out     dx,al
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
%endif
...
%if FRONT_PANEL
	PUSH 	DS
        ...
        pop     ds              ; Source
	mov  dx,POSTMSG		;    	
    	mov  ah, 0x51       	; ah=0x51 - "Write BUFFER TO FRONT PANEL"
    	INT  0x15  		;
    	pop 	DS
%endif
...
; no serial interface -- it is used for the video driver
	mov	ax,PARALLEL_1|SERIAL_0|FLOPPIES_1|VIDEO_MONO|HAS_FLOPPY
%if FPEM
