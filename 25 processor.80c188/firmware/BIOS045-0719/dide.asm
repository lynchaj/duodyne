...
%include	"cpuregs.asm"
%include	"equates.asm"
; number of NOPs between word reads; 0 for fastest I/O
%define	SLOW_IO		8

        global  DIDE_BIOS_call_13h
        global  _DIDE_WRITE_SECTOR
        global  _DIDE_READ_SECTOR
        global  _DIDE_READ_ID
        extern  @mulLS
        extern  microsecond
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;  BIOS call entry for DIDE Fixed Disk driver
;       int  13h
;
...
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
DIDE_BIOS_call_13h:          ; Floppy driver entry
	...
	global	DIDE0_entry, DIDE1_entry
DIDE0_entry:
DIDE1_entry:
        xor     bx,bx           ; zero extend byte
...
.0:	add     si,cx                   ; point at fx8?
	...
	jnz	.0
.1:
	mov	di,DIDE0		; first controller device code
	test	byte [fx_drive_control - fx80 + si],2
	jz	.15
	mov	di,DIDE1		; second controller
.15:
        push    si
...
; LBA call is okay
        ...
        jnz     .3
.2:     call    @DIDE_READ_SECTOR
        jmp     .5
.3:     call    @DIDE_WRITE_SECTOR
        jmp     .5
.4:     call    @DIDE_VERIFY_SECTOR
