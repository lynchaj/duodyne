; Flasher program to update 39SF040 Flash ROM on SAB80535 dev board
...
.equ	vector, 0xA000		;location to LJMP interrupt vectors
...
.equ	pgm, 0xA000		;default location for the user program
;.equ	bmem, 0x1000		;where is the beginning of memory
.equ	bmem, 0x9000		;where is the beginning of memory
;.equ	emem, 0xFFFF		;end of the memory
.equ	emem, 0xF7FF		;end of the memory (32KB page of RAM minus IO space)
...
.equ	baud_const, 208		;1200 baud w/ 11.0592 MHz
;.equ	baud_const, 252		;19200 baud w/ 14.7456 MHz
;.equ	baud_const, 243		;4808 baud w/ 12 MHz
;.equ	baud_const, 230		;1200 baud w/ 6.0000 MHz
...
.equ	bflash, 0x0000		;first memory location of Flash ROM
;.equ	eflash, 0xFFFF		;last memory location of Flash ROM
.equ	eflash, 0x7FFF		;last memory location of Flash ROM
